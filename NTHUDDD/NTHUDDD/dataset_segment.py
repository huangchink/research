...
if __name__ == "__main__":
    # 处理训练集
    train_roots = [
        "/home/tchuang/research/NTHUDDD/Training_Evaluation_Dataset/TrainingDataset"
    ]
    segment_videos(train_roots, out_root="NTHU_modify/training", eval=False)

    # 处理评估集
    eval_roots = [
        "/home/tchuang/research/NTHUDDD/Training_Evaluation_Dataset/EvaluationDataset"
    ]

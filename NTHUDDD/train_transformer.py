...
from dataset_NTHUDDD_DGM import NTHUDDDDataset
...
def main():
    ...
    train_dataset = NTHUDDDDataset(train_root, sequence_length=args.sequence_length, stride=args.stride, frame_skip=1, eval=False)
    val_dataset   = NTHUDDDDataset(eval_root,  sequence_length=args.sequence_length, stride=args.stride, frame_skip=1, eval=True)

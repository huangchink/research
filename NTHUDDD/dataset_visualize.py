...
def process_video(video_path, out_path='output.avi'):
    # 載入模型
    DriverGaze = DGMnet()
    ckpt = '/home/remote/tchuang/research/NTHUDDD/loadmodel/eyetracking_gray.pt'
...
if __name__ == '__main__':
    train_root = '/home/remote/tchuang/research/NTHUDDD/Training_Evaluation_Dataset/EvaluationDataset'
    vids = glob.glob(os.path.join(train_root, '**', '*.avi'), recursive=True) \

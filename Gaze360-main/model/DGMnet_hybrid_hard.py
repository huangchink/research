...
#         encoder_norm = RMSNorm(input_dim)
...
#                                        layer_num=6, pred_num=1, length=len([124, 262,328,654,128]))
...
#         pyramidfeature = self.transformer(fusion_input, 1)
#         #print(pyramidfeature.shape)

#         # 計算 gaze (目光方向)
#         gaze = self.fc(pyramidfeature)
#         #print(gaze.shape)
#         return gaze,gaze1,gaze_list[0],gaze_list[1],gaze_list[2],gaze_list[3]
...
# #         x1 = self.features1_3(self.features1_2(self.features1_1(x)))
# #         return x1
# # class EyeImageModel2(nn.Module):
# #     def __init__(self):
# #         super(EyeImageModel2, self).__init__()
# #         self.maxpool = nn.MaxPool2d(kernel_size=3, stride=1)
# #         self.features1_1 = nn.Sequential(
# #             nn.Conv2d(3, 64, 3, 1, 1, dilation=(2, 2)),
# #             nn.BatchNorm2d(64),
...
# #             nn.ReLU(),
# #             CBAM(64),
# #             nn.Conv2d(64, 48, 3, 1, 1, dilation=(2, 2)),
# #             nn.BatchNorm2d(48),
# #             nn.ReLU(),
# #         )
...
# #         self.conv = nn.Sequential(
# #             nn.Conv2d(3, 48, kernel_size=3, stride=2, padding=0),
# #             nn.GroupNorm(6, 48),
# #             nn.ReLU(),
...
# #             nn.ReLU(),
# #             nn.MaxPool2d(kernel_size=3, stride=2),
# #             nn.Conv2d(96, 128, kernel_size=3, stride=1, padding=2),
# #             nn.GroupNorm(16, 128),
# #             nn.ReLU(),
# #             nn.MaxPool2d(kernel_size=3, stride=2),
...
# #             nn.ReLU(),
# #             CBAM(128),
# #             nn.Conv2d(128, 64, kernel_size=3, stride=2, padding=0, dilation=(2, 2)),
# #             nn.GroupNorm(8, 64),
# #             nn.ReLU(),
# #             CBAM(64)
# #         )
...
# #         out = self.conv(x)
# #         return out
# # class FaceImageModel2(nn.Module):
# #     def __init__(self):
# #         super(FaceImageModel2, self).__init__()
# #         self.conv = nn.Sequential(
# #             nn.Conv2d(3, 48, kernel_size=3, stride=2, padding=0),
# #             nn.GroupNorm(6, 48),
# #             nn.ReLU(),
...
# #         GAZE_features = torch.cat((xFace, xEyeL, xEyeR), 1)
# #         GAZE_features = self.mix(GAZE_features)
# #         # print('GAZE_features',GAZE_features.shape)

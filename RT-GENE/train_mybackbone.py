...
if __name__ == "__main__":
    ...
    for fold in range(3):
        ...
        val_dataset = dataloader.txtload(val_file, imagepath, 16, num_workers=4, header=True)
        ...
        print("Training")
        best_val_error = float("inf")  # 記錄本 fold 最佳驗證誤差
        best_epoch = -1
        fold_val_error = None
        ...
        for epoch in range(1, config["params"]["epoch"] + 1):
            ...
            if epoch >= 5:
                ...
                fold_val_error = val_error  # 更新本 fold 的最新驗證誤差
        ...
        all_validation_errors.append(fold_val_error)

    # 輸出 3-Fold Cross Validation 的平均結果
    avg_validation_error = np.mean(all_validation_errors)
    print(f"\n=== 最終 3-Fold Cross Validation 平均誤差: {avg_validation_error:.2f} degrees ===")
